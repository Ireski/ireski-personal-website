...
const progressElements = [
  ...
  { id: "progress5", textId: "text-percentage5", percentage: 87 },
  { id: "progress6", textId: "text-percentage6", percentage: 34 },
];
...
const iconLinks = document.querySelectorAll("i");
...
window.addEventListener("scroll", () => {
  ...
  iconLinks.forEach((iclink) => {
    iclink.classList.remove("active");
    if (link.getAttribute("href") === `#${current}`) {
      iclink.classList.add("active");
    }
  });
});
// });
